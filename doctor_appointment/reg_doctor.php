...
<head>
	...
	<title>DOCTOR APPOINTMENT SYSTEM - &amp; Register Doctor</title>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu" href="index.php">our team</a></li>
				...
				<!-- 	<div class="col-md-5 contact-info text-left">
					...
					<div class="col-md-8 col-md-offset-1 contact-form">
						...
						<form class="form" method="POST" action="insertion.inc.php">
							<input class="name" type="text" required name="fname" placeholder="Fullname">
							<input class="email" type="email" required name="email" placeholder="Email">
							<input class="phone" type="text" required name="phone" placeholder="Phone No.">
							<input class="special" type="text" required name="spec" placeholder="Speciality">
							<input class="name" type="text" required name="rq" placeholder="Recovery Question">
							<input class="name" type="text" required name="ra" placeholder="Recovery Answer">
							...
							<br>
							<br>
							<input class="submit-btn" type="submit" name="addd" value="SUBMIT">
						</form>
					</div>
				</div>
			</div>
