...
$sql = "SELECT * FROM `appointments` WHERE `User_ID` = '$uid'";
...
<br>
        ...
        <div>
<input class="submit-btn" type="submit" value="Print List of My Appointments" onclick="printData()">
        </div>
          <br>
        <p>Click <a href="set_appointment.php">HERE</a> to Set an Appointment.</p>
           <br>
        <p>Click <a href="cancel_appointment.php">HERE</a> to Cancel an Appointment.</p>
      </div>
    </div>
  ...
  <section class="service text-center" id="doctors">
    <div class="container">
      <div class="row">
        ...
        <h4>Below are all the doctors under our system:</h4>
        <div class="col-md-4 col-sm-6">
...
$sql = "SELECT `Doctor_ID`, `Fullname`, `Email_Address`, `Phone_Number` FROM `doctors`";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
