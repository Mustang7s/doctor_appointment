...
<head>
  ...
  <title>DOCTOR APPOINTMENT SYSTEM - &amp; Delete Doctor</title>
        ...
        <!--  <div class="col-md-5 contact-info text-left">
          ...
          <div class="col-md-8 col-md-offset-1 contact-form">
            ...
            <form class="form" method="POST" action="insertion.inc.php">
              <input class="email" required type="text" name="did" placeholder="Doctor ID">
              <br>
              <br>
              <input class="submit-btn" type="submit" name="deleted" value="SUBMIT">
            </form>
          </div>
        </div>
      </div>
