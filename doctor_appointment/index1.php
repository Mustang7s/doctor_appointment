...
if (!isset($_SESSION['Email1']) && !isset($_SESSION['docname'])) {
    header("Location: index.html");
}else{
  $email = $_SESSION['Email1'];
  $did = $_SESSION['docname'];
  $date = date("m/d/Y");
  $query=mysqli_query($conn,"SELECT * FROM `doctors` WHERE `Email_Address`='$email'")or die(mysqli_error());
...
<!-- about section -->
  <section class="about text-center" id="about">
    <div class="container">
      <div class="row">
        <h2>about us</h2>
        <h4>We facilitate the booking and management of patients’ appointments. Allowing healthcare workers to easily access and manage patients’ appointments and generate relevant reports. More so, twe are useful in particular for Doctor Agencies, Hospitals, clinics, maternity care, and consultancy about patient-related business. A patient can create an appointment directly from the website!</h4>
        <div class="col-md-4 col-sm-6">
          <div class="single-about-detail clearfix">
            <div class="about-img">
              <img class="img-responsive" src="img/i1.jpg" alt="">
            </div>
            <div class="about-details">
              ...
              <p>We prioritise the future generations!</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
          <div class="single-about-detail">
            <div class="about-img">
              <img class="img-responsive" src="img/i2.jpg" alt="">
            </div>
            <div class="about-details">
              <div class="pentagon-text">
                <h1>W</h1>
              ...
              <p>We help our women to live healthy and long lives!</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
          <div class="single-about-detail">
            <div class="about-img">
              <img class="img-responsive" src="img/i3.jpg" alt="">
            </div>
            <div class="about-details">
              <div class="pentagon-text">
                <h1>M</h1>
              </div>
              <h3>Men’s specialist</h3>
              <p>We help our men to lead strong and healthy lives!</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="service text-center" id="appointments">
    <div class="container">
      <div class="row">
        <h2>List of My Appointments</h2>
        <h4>Below are all the appointments that have been made to you:</h4>
        <div class="col-md-4 col-sm-6">
...
<th style="text-align: left;
  ...
  padding: 8px;">Time</th>
  <th style="text-align: left;
  padding: 8px;">Additional Information</th>
   <th style="text-align: left;
  padding: 8px;">Billing</th>
    <th style="text-align: left;
...
echo "<tr><td>" . $row["Appointment_ID"] . "</td><td>" . $row["Date"] . "</td><td>" . $row["Time"] . "</td><td>" . $row["Additional_Information"] . "</td><td>" . $row["Billing"] . "</td><td>" . $row["Status"] . "</td></tr>";
}
echo "</table>";
...
<br>
        ...
        <div>
<input class="submit-btn" type="submit" value="Print List of My Appointments" onclick="printData1()">
        </div>
          <br>
        <p>Click <a href="respond_appointment.php">HERE</a> to Respond to an Appointment Request.</p>
      </div>
    </div>
