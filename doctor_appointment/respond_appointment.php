...
<head>
  ...
  <title>DOCTOR APPOINTMENT SYSTEM - &amp; Respond to Appointment</title>
        ...
        <!--  <div class="col-md-5 contact-info text-left">
          ...
          <div class="col-md-8 col-md-offset-1 contact-form">
            ...
            <form class="form" method="POST" action="insertion.inc.php">
              <input class="email" type="text" required name="aid" placeholder="Appointment ID">
              <label>Select Response:</label>
              <select name="stat" required>
                <option selected disabled value="">Select Response</option>
                <option value="Available, looking forward to assisting you!">Available, looking forward to assisting you!</option>
                <option value="Pending...">Pending</option>
                <option value="Not Available, kindly reschedule for another date or time.">Not Available, kindly reschedule for another date or time.</option>
                <option value="Completed">Appointment has been completed.</option>
              </select>
              <br>
              <br>
              <input class="submit-btn" type="submit" name="upa" value="SUBMIT">
            </form>
          </div>
        </div>
      </div>
